...
public class ViewUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       HttpSession session = request.getSession();
            ...
            out.println("<th>Objetivo</th>");
            out.println("<th>Lesiones</th>");
            out.println("</tr>");
            ...
            while (contactos.next()) {
                ...
                out.println("<td>" + contactos.getString("correo") + "</td>");
                out.println("<td>" + contactos.getString("celular") + "</td>");
                out.println("<td>" + contactos.getInt("edad") + "</td>");
                out.println("<td>" + contactos.getInt("peso") + "</td>");
                out.println("<td>" + contactos.getString("objetivo") + "</td>");
                out.println("<td>" + contactos.getString("lesion") + "</td>");
                out.println("</td>");
                out.println("</tr>");
            }
            out.println("</table>");
            out.println("<a href='index.html'>Volver a pagina inicial</a>");
            out.println("</body>");
            out.println("</html>");
