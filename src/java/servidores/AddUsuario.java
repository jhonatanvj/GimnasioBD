...
public class AddUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            c.setCelular(Integer.parseInt(request.getParameter("celular")));
            c.setEdad(Integer.parseInt(request.getParameter("edad")));
            c.setPeso(Integer.parseInt(request.getParameter("peso")));
            c.setObjetivo(request.getParameter("objetivo"));
            c.setLesiones(request.getParameter("lesiones"));   
            conDb.insertarUsuario(c);
            
            response.sendRedirect("InicioAddUsuario");
